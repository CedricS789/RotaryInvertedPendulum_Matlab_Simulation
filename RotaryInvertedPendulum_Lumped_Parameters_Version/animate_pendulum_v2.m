function animate_pendulum_v2(t, phi, theta, l, r)
    ...
    line_width = 4;          % Line width for arm and pendulum
    line_base_width = 2*7;
    bob_size = 8;            % Marker size for the pendulum bob
    font_size = 12;          % Font size for labels and title
    motor_height = l + 0.1;  % Height of the motor (pivot point) above the floor
    ...
    pendulum = plot3([x_pivot(1), x_bob(1)], [y_pivot(1), y_bob(1)], [z_pivot(1), z_bob(1)], 'r-', 'LineWidth', line_width/4);
